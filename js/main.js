$(document).ready(function() {
	...
	var mobile = jQuery.browser.mobile; //Ture if it's mobile device

	volumeUpdate(); //updates volume on start

	if (mobile) {
		$("#radio-volume-icon, #radio-volume").hide(); //no need for vol. controls
	}
	...
	function volumeUpdate() {
		...
		$(".volume-handler").css({"left":(volume * 0.93 + 4)+"%"});
		volumeIconUpdate();
	}
...
//FUNCTION FOR MOBILE DETECTION, jQuery.browser.mobile param returns true/false (true for mobile)
